...
export default () => {
	...
	const { resource } = useResource({
		...
		link: `${window.location.origin}/api/jsonws/country/get-countries?p_auth=` + Liferay.authToken,
	...
	const initLoading = networkStatus === 1;
		...
		<ClayAutocomplete>
			...
			>
				<ClayDropDown.ItemList>
					{(error || (!initLoading && filteredResource.length == 0)) && (
